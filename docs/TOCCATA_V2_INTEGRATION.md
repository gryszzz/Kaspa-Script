# Toccata v2.0.0 Integration Brief

Prepared: 2026-06-05.

This is the KaspaScript source-grounded integration brief for Rusty Kaspa
`v2.0.0`, the tagged mainnet Toccata release.
...
`v2.0.0` is the mainnet Toccata release. The release schedules hardfork
activation at DAA score `474,165,565`, roughly 2026-06-30 16:15 UTC.

KaspaScript therefore treats `v2.0.0` as:
...
| Area | v2.0.0 signal | KaspaScript integration |
| --- | --- | --- |
...
| Fees | Minimum standard fee policy is `100 sompi * max(compute grams, 2 * transaction bytes)`. | Point kernel fee estimates at the tagged v2.0.0 guide. |
...
- tagged release metadata and release assets
